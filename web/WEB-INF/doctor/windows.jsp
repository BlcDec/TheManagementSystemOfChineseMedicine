    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <%--<form id="add_form" action="add.php" method="post" enctype="multipart/form-data">--%>
                <%--&lt;%&ndash;<div class="form-group" align="left">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="input-group">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<span class="input-group-addon">症状描述</span>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<input type="text" name="isbn" id="isbn" placeholder="请简单描述您的症状" class="form-control"&ndash;%&gt;--%>
                <%--&lt;%&ndash;aria-describedby="sizing-addon2">&ndash;%&gt;--%>
                <%--&lt;%&ndash;&lt;%&ndash;<span class="input-group-btn">&ndash;%&gt;&ndash;%&gt;--%>
                <%--&lt;%&ndash;&lt;%&ndash;<button class="btn btn-default" type="button" onclick="get_book_info()">获取信息</button>&ndash;%&gt;&ndash;%&gt;--%>
                ...
                <%--<div class="form-group" align="left">--%>
                    ...
                    <%--&lt;%&ndash;<span class="input-group-addon">预约科室</span>&ndash;%&gt;--%>
                    ...
                    <%--&lt;%&ndash;内科<span class="caret"></span>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</button>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<ul class="dropdown-menu">&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<li><a href="#">呼吸内科</a></li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<li><a href="#">内分泌科</a></li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<li><a href="#">神经内科</a></li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<li role="separator" class="divider"></li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<li><a href="#">老年科</a></li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<li><a href="#">儿童科</a></li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<li><a href="#">牙科</a></li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--</div>--%>
                <%--<div class="form-group" align="left">--%>
