        ...
        <div id="page-inner">
            ...
            <div class="list-group">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                    <%List<AppointmentOrRegistration> lists = (List<AppointmentOrRegistration>) request.getAttribute("underway_appointment");%>
